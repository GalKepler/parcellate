...
from parcellate.interfaces.cat12.cat12 import _build_output_path, _extract_and_write_tiv, _find_first_tiv, _write_output
...
def process_single_subject(
    ...
    # Extract TIV once for column injection and standalone TSV
